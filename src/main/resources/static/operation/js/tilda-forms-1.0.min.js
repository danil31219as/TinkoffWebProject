...
// }((function ($) {
//     var ua = navigator.userAgent, iPhone = /iphone/i.test(ua),
...
//                     if (!input.prop("readonly")) {
//                         var k = e.which || e.keyCode, pos = input.caret(), p, c,
//                             next;
...
//                 virtPrice = arArgs.amount, virtProduct = arArgs.description,
//                 currency;
...
//             }), 200), !1;
//             var currency = arArgs.currency, language = arArgs.language,
//                 initCP = {};
...
//         }));
//         try {
//             var TILDAPAGE_URL = window.location.href, TILDAPAGE_QUERY = "",
//                 TILDAPAGE_UTM = "";
